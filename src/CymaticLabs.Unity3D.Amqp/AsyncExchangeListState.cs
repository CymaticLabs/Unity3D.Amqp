...
{
    /// <summary>
    /// A state object used for async web requests when fetching exchange data.
    /// </summary>
    public class AsyncExchangeListState
    {
        /// <summary>
        ...
        /// <summary>
        /// The exchange list callback that will receive the aysnc exchange list results.
        /// </summary>
